...
| [SHARED_HARDWARE_RESOURCES.md](SHARED_HARDWARE_RESOURCES.md) | 2026-09-05 | 192.168.0.53 | TTBOX 在 RK3588 上的硬件资源边界（HDMI-IN、USB-HID、NPU 抢占等） |

## 何时更新

- 模块新增/删除/重命名 → 更新 CURRENT + DEEP_DIVE
- 出现新的硬件冲突 → 更新 SHARED_HARDWARE_RESOURCES
