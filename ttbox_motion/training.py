...
class MotionProfileStore:
    ...
    def create_profile(self, name: str) -> dict[str, Any]:
        ...
        profile = {
            ...
            "model": {
                ...
                "ready": False, "quality": 0, "knots": [],
                "exists": False, "sample_count": 0, "coverage": {},
            },
    ...
    def clear_samples(self, profile_id: str) -> dict[str, Any]:
        ...
        profile["samples"] = []
        profile["model"] = {
            "schema": "ttbox.motion-model.v1", "ready": False, "quality": 0, "knots": [],
            "exists": False, "sample_count": 0, "coverage": {},
        }
        self._summary(profile)
        profile["updated_at_ms"] = int(time.time() * 1000)
    ...
    def _public(profile: dict[str, Any]) -> dict[str, Any]:
        ...
        result["model"].setdefault("sample_count", 0)
        result["model"].setdefault("coverage", {})
        return result
